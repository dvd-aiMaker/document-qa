def GPT_prompt(client):
    ...
    if client == "Ponctuel":
        ...
        prompt1 += " Ajoutes une clé correspondant à la Designation. Cette valeur correspond à la description de la marchandise et commence par un code alpanumérique."
